      ...
      <div className="about-container">
        <div className="about-header">
          ...
          <div className="about-text">
            ...
            <p className="info">
              "Along with the continuous development of world fashion, many
              brands have launched genuine men's watches with a variety of
              styles, designs, colors, sizes... A key high-end men's watch The
              brand portrays a true value when it comes to luxury accessories
              for men. Nowadays, watches are essential fashion accessories for
              today's modern man. On the wrists of successful men there is
              always a place for a high-end men's watch"
            </p>
          </div>
        </div>
        <div className="about-info">
          <div className="genuine">
            ...
            <div className="genuine-text">
              <h3>Genuine</h3>
              <p>
                Nowadays, watches are essential fashion accessories for today's
                modern man
              </p>
            </div>
          </div>
