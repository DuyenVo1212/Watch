      ...
      <div className="footer-container">
        ...
        <div className="footer-info">
          ...
          <div className="contact-info">
            ...
            <div className="info">
              <p>
                <i className="fa fa-map-marker"></i>District Go Vap, Ho Chi Minh
                City
              </p>
              <p>
                <i className="fa fa-phone"></i>+84 890 4951
              </p>
              <p>
          ...
          <div className="about-us">
            ...
            <div className="info">
              ...
              <p>
                <i className="fa fa-arrow-right"></i>Mona Devices
              </p>
              <p>
                <i className="fa fa-arrow-right"></i>Mona Science
              </p>
            </div>
          </div>
